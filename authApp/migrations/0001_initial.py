# Generated by Django 3.2.8 on 2021-11-11 03:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom_equipo', models.CharField(max_length=20, verbose_name='nom_equipo')),
                ('ip', models.CharField(max_length=20, verbose_name='ip')),
                ('ambiente', models.CharField(max_length=30, verbose_name='ambiente')),
                ('sistema', models.CharField(max_length=20, verbose_name='Sistema')),
            ],
            options={
